...
# calculate TWL in two ways ---------------------------------------------------------------------
  ...
  # -------------------------------------------------------  bmi  2024-02-23
  # 
  m_bmi_0_GS <-  lm(formula = bmi_5a ~ bmi_0 +  p_alder_v_op + Female  + o_preop_vektskole + b_beh_diab + smoke  ,  # remove bmi_0
                    data = d_elig_GS |> filter(a5_nt))  #   
  summary(m_bmi_0_GS) 
  
  m_bmi_0_GB <-  lm(formula = bmi_5a ~ bmi_0 +  p_alder_v_op + Female  + o_preop_vektskole + b_beh_diab + smoke  ,  # remove bmi_0
                    data = d_elig_GB |> filter(a5_nt))  #   
  summary(m_bmi_0_GB) 
  # --- 
  
  
  m_bmi_GS   <- lmer(formula = bmi_5a ~ bmi_0 +  p_alder_v_op + Female  + o_preop_vektskole + b_beh_diab + smoke +(1|o_sykehus),  # remove bmi_0
                     data = d_elig_GS |> filter(a5_nt))  #  
  summary(m_bmi_GS)
  REff_bmi_GS  = ranef(m_bmi_GS)
  RE_tbbl_bmi_GS = as_tibble(REff_bmi_GS)
  
  m_bmi_GB   <- lmer(formula = bmi_5a ~ bmi_0 +  p_alder_v_op + Female  + o_preop_vektskole + b_beh_diab + smoke +(1|o_sykehus),  # remove bmi_0
                     data = d_elig_GB |> filter(a5_nt))  #  
  summary(m_bmi_GB)
  ...
  # -------------------------------------------------------  TWL  2024-02-23
  # 
  m_TWL_0_GS <-  lm(formula = a5_TWL ~ bmi_0 +  p_alder_v_op + Female  + o_preop_vektskole + b_beh_diab + smoke  ,  # remove bmi_0
                    data = d_elig_GS |> filter(a5_nt))  #   
  summary(m_TWL_0_GS) 
  
  m_TWL_0_GB <-  lm(formula = a5_TWL ~ bmi_0 +  p_alder_v_op + Female  + o_preop_vektskole + b_beh_diab + smoke  ,  # remove bmi_0
                    data = d_elig_GB |> filter(a5_nt))  #   
  summary(m_TWL_0_GB) 
  # --- 
  
  
  m_TWL_GS   <- lmer(formula = a5_TWL ~ bmi_0 +  p_alder_v_op + Female  + o_preop_vektskole + b_beh_diab + smoke +(1|o_sykehus),  # remove bmi_0
                     data = d_elig_GS |> filter(a5_nt))  #  
  summary(m_TWL_GS)
  ...
  m_TWL_GB   <- lmer(formula = a5_TWL ~ bmi_0 +  p_alder_v_op + Female  + o_preop_vektskole + b_beh_diab + smoke +(1|o_sykehus),  # remove bmi_0
                     data = d_elig_GB |> filter(a5_nt))  #  
  summary(m_TWL_GB)
